...
java -cp $CLASSPATH -Djava.security.policy=$POLICYFILE network.DisControllerImpl 0 5 $NODE1_FILE n2:offer,n3:offer &
echo $! >> $PIDFILE
java -cp $CLASSPATH -Djava.security.policy=$POLICYFILE network.DisControllerImpl 1 5 $NODE2_FILE ok,wait_list,refuse,offer,has_wait,neg_offer,scholarship,different_student,n4:apply,n5:apply,n4:refuse,n5:refuse &
echo $! >> $PIDFILE
java -cp $CLASSPATH -Djava.security.policy=$POLICYFILE network.DisControllerImpl 2 5 $NODE3_FILE ok,wait_list,refuse,offer,has_wait,neg_offer,scholarship,different_student,n4:apply,n5:apply,n4:refuse,n5:refuse &
echo $! >> $PIDFILE
java -cp $CLASSPATH -Djava.security.policy=$POLICYFILE network.DisControllerImpl 3 5 $NODE4_FILE n2:scholarship,n3:scholarship,n2:offer,n3:offer,apply,pick,refuse &
echo $! >> $PIDFILE
java -cp $CLASSPATH -Djava.security.policy=$POLICYFILE network.DisControllerImpl 4 5 $NODE5_FILE n2:scholarship,n3:scholarship,n2:offer,n3:offer,apply,pick,refuse &
echo $! >> $PIDFILE
