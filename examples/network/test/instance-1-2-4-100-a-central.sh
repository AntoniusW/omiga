...
export NODE1_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-org-n1.lp
export NODE2_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-provider-n2.lp
export NODE3_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-provider-n3.lp
export NODE4_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-student-n4.lp
export NODE5_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-student-n5.lp
export NODE6_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-student-n6.lp
export NODE7_FILE=$BASEDIR/examples/network/test/instance-1-2-4-100-a-student-n7.lp
export SLEEP=5
...
time java -cp $CLASSPATH -Djava.security.policy=$POLICYFILE network.AController 7 $1
