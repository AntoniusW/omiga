...
#                     reach reachplus birds   3col   stratProg
#declare -a n_answers=(1     1        1       1 5   1 5)
#declare -a no_n_answers=(1 1 1 2 2)
#declare -a start_n_answers=(0 1 2 3 5)

#                      reach     birds                3col                 reachplus      stratProg
#declare -a test_names=(1 2      1000 10000    10-18 20-38 30-64    1 2 3          10 100 200)
#declare -a no_test_names=(2 2 3 3 3)
#declare -a start_test_names=(0 2 4 7 10)

#                     reach birds   3col  reachplus  stratProg
#declare -a n_answers=(0 1    0 1      1 5   0          1 5)
#declare -a no_n_answers=(2 2 2 1 2)
#declare -a start_n_answers=(0 2 4 6 7)
...
export DLV="/home/staff/aweinz/src/bin/dlv"
export SICSTUS="$SICSTUSPATH/sicstus"
export CLINGO="$CLINGOPATH/clingo"
export OMIGA="java -Xms256m -Xmx2000m -cp $CLASSPATH woc.classinstances.main_FINAL_NormalASP"
